...
function saveMessage(messageText) {
  ...
  return firebase.database().ref('/messages/').push({
    ...
    console.error('Error while adding new message to Firebase Database',error);
  });
}
  ...
  firebase.database().ref('/messages/').push({
    ...
    return firebase.storage().ref(filePath).put(file).then(function(fileSnapshot){
      ...
      return fileSnapshot.ref.getDownloadURL().then((url) => {
        //update chatmessage placeholder with image url
    ...
    console.error('There was error uploading image to cloud database',error);
  });
}
...
//     if(currentToken) {
//       console.log('Got the current token', currentToken);
...
function requestNotificationsPermissions() {
  ...
  console.log('Requesting users permissions...' );
